...
export default function OrdenDeCompra() {
  ...
  ,[])
      ...
      return (
        <Container  sx={{ maxWidth: 345, m:5,display:'flex', flexDirection:'column',  alignItems: 'center', justifyContent: 'center', width:1}}>
        <Typography sx={{textAlign: 'center', fontSize: 35, my:5}}>Detalles de la Compra</Typography>
        <Card sx={{ maxWidth: 345}}>
          <CardActionArea>
            ...
            />
            <CardContent>
              <Typography gutterBottom variant="h5" component="div" sx={{fontSize:28}}>

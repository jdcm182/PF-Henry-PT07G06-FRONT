...
export default function Detail() {
  ...
  (p&&Object.keys(p).length !== 0)?console.log(p):
     ...
     p={
        ...
        price:36500.00,
        condition: 'half-used',
        image:"https://res.cloudinary.com/duq1tcwjw/image/upload/v1665861632/PF-JUIRA/Products/Sillon_usado_vxwb69.jpg",
     }

  return (
    <Container
    sx={{ backgroundImage: `url(https://res.cloudinary.com/duq1tcwjw/image/upload/v1665859347/PF-JUIRA/background_nwqllc.jpg)`,
    mt:2,
    width: 1,
    height: 1,
    p: 5,

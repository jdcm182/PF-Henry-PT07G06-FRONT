...
export default function SellForm() {
  ...
  return (
    ...
    <Container sx={{
      background: 'var(--UiLightColor)'/* 'linear-gradient( 90deg, white, #b6deb8 10%, #b6deb8 90%, white )' */,
      display: 'flex', flexDirection: 'column', width: 1, my: 0,
      boxShadow: '0 0 15px 5px #cccccc55', padding: 5
    }}>

      <DocumentTitle title="Formulario de Venta | Juira"></DocumentTitle>
      ...
      >
        ...
        <Stack direction="row" alignItems="center" spacing={1} sx={{ width: 1, justifyContent: 'space-around' }}>
          ...
          <Stack direction="row" alignItems="center" spacing={2}>
            ...
            <div>
              {previewSource ? (
                <img src={previewSource} alt='chosenOne' style={{
                  height: '250px', margin: '10px', width: '250px', border: '2px dashed green'
                }} />
              ) : (error.image) ?
